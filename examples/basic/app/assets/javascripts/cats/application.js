...
$(document).ready(function(){
  var cats = new AngryCats([
      new AngryCat({ name: 'Wet Cat', image_path: '/assets/cat2.jpg' }),
      new AngryCat({ name: 'Bitey Cat', image_path: '/assets/cat1.jpg' }),
      new AngryCat({ name: 'Surprised Cat', image_path: '/assets/cat3.jpg' })
  ]);
